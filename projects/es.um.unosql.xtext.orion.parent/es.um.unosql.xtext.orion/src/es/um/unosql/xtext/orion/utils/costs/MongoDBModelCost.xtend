...
class MongoDBModelCost
{
  ...
  private def dispatch OperationCost getCostFrom(AttributePromoteOp op)      { return OperationCost.NO_COST_OP            }
  private def dispatch OperationCost getCostFrom(AttributeDemoteOp op)       { return OperationCost.NO_COST_OP            }
  ...
  private def dispatch OperationCost getCostFrom(AggregateMorphOp op)        { return OperationCost.MULTIPLE_TRAVERSAL_OP }
}
