...
public class NoSQLSchemaPackageImpl extends EPackageImpl implements NoSQLSchemaPackage {
	 ...
	 * @see es.um.nosql.streaminginference.NoSQLSchema.NoSQLSchemaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		noSQLSchemaEClass.getESuperTypes().add(this.getSerializable());
		entityEClass.getESuperTypes().add(this.getSerializable());
		entityVersionEClass.getESuperTypes().add(this.getSerializable());
		propertyEClass.getESuperTypes().add(this.getSerializable());
		attributeEClass.getESuperTypes().add(this.getProperty());
		typeEClass.getESuperTypes().add(this.getSerializable());
