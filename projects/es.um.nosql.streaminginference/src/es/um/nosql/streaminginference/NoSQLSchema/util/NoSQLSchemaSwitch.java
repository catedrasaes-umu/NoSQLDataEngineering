	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NoSQLSchemaPackage.NO_SQL_SCHEMA: {
				...
				if (result == null) result = caseSerializable(noSQLSchema);
			...
			case NoSQLSchemaPackage.ENTITY: {
				...
				if (result == null) result = caseSerializable(entity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NoSQLSchemaPackage.ENTITY_VERSION: {
				...
				if (result == null) result = caseSerializable(entityVersion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NoSQLSchemaPackage.PROPERTY: {
				...
				if (result == null) result = caseSerializable(property);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case NoSQLSchemaPackage.ASSOCIATION: {
				...
				if (result == null) result = caseSerializable(association);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NoSQLSchemaPackage.REFERENCE: {
				...
				if (result == null) result = caseSerializable(reference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NoSQLSchemaPackage.AGGREGATE: {
				...
				if (result == null) result = caseSerializable(aggregate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NoSQLSchemaPackage.PRIMITIVE_TYPE: {
				...
				if (result == null) result = caseSerializable(primitiveType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NoSQLSchemaPackage.SERIALIZABLE: {
