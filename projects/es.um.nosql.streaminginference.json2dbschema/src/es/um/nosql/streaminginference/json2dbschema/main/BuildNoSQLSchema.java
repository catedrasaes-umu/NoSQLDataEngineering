package es.um.nosql.streaminginference.json2dbschema.main;
...
import es.um.nosql.streaminginference.json2dbschema.util.abstractjson.impl.gson.GsonAdapter;
import es.um.nosql.streaminginference.json2dbschema.util.abstractjson.impl.gson.GsonArray;
