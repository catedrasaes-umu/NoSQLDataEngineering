...
class AthenaSemanticHighlightingCalculator extends DefaultSemanticHighlightingCalculator
{
  ...
  override protected boolean highlightElement(EObject object, IHighlightedPositionAcceptor acceptor, CancelIndicator cancelIndicator)
  {
    switch (object)
    {
      AthenaSchema:                            { highlightFeature(acceptor, object, AthenaPackage.eINSTANCE.athenaSchema_Name, HighlightingStyles.DEFAULT_ID) }
      ...
      SimpleAggregationTarget:                 { highlightFeature(acceptor, object, AthenaPackage.eINSTANCE.simpleAggregationTarget_Aggr, HighlightingStyles.DEFAULT_ID) }
