...
/**
 * This is the item provider adapter for a {@link es.um.nosql.s13e.NoSQLSchema.Property} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         NoSQLSchemaPackage.Literals.PROPERTY__NAME,
         true,
         false,
         false,
  ...
  protected void addOptionalPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Property_optional_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Property_optional_feature", "_UI_Property_type"),
         NoSQLSchemaPackage.Literals.PROPERTY__OPTIONAL,
         true,
         false,
         false,
