...
public interface EntityDifferentiationPackage extends EPackage
{
  ...
  /**
	 * The meta object id for the '{@link es.um.nosql.s13e.EntityDifferentiation.impl.StructuralVariationPropImpl <em>Structural Variation Prop</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see es.um.nosql.s13e.EntityDifferentiation.impl.StructuralVariationPropImpl
	 * @see es.um.nosql.s13e.EntityDifferentiation.impl.EntityDifferentiationPackageImpl#getStructuralVariationProp()
	 * @generated
	 */
  ...
  /**
	 * Returns the meta object for the containment reference list '{@link es.um.nosql.s13e.EntityDifferentiation.EntityDiffSpec#getVariationProps <em>Variation Props</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Variation Props</em>'.
	 * @see es.um.nosql.s13e.EntityDifferentiation.EntityDiffSpec#getVariationProps()
	 * @see #getEntityDiffSpec()
	 * @generated
	 */
  ...
  /**
	 * Returns the meta object for class '{@link es.um.nosql.s13e.EntityDifferentiation.StructuralVariationProp <em>Structural Variation Prop</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	EClass getStructuralVariationProp();
		...
		/**
	 * Returns the meta object for the containment reference list '{@link es.um.nosql.s13e.EntityDifferentiation.StructuralVariationProp#getPropertySpecs <em>Property Specs</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Property Specs</em>'.
	 * @see es.um.nosql.s13e.EntityDifferentiation.StructuralVariationProp#getPropertySpecs()
	...
	EReference getStructuralVariationProp_PropertySpecs();
		...
		/**
	 * Returns the meta object for the reference '{@link es.um.nosql.s13e.EntityDifferentiation.StructuralVariationProp#getVariation <em>Variation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Variation</em>'.
	 * @see es.um.nosql.s13e.EntityDifferentiation.StructuralVariationProp#getVariation()
	 * @see #getStructuralVariationProp()
	 * @generated
	 */
	EReference getStructuralVariationProp_Variation();
		...
		/**
	 * Returns the meta object for the containment reference list '{@link es.um.nosql.s13e.EntityDifferentiation.StructuralVariationProp#getNotProps <em>Not Props</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Not Props</em>'.
	 * @see es.um.nosql.s13e.EntityDifferentiation.StructuralVariationProp#getNotProps()
	 * @see #getStructuralVariationProp()
	 * @generated
	 */
  ...
  interface Literals
  {
    ...
    /**
		 * The meta object literal for the '{@link es.um.nosql.s13e.EntityDifferentiation.impl.StructuralVariationPropImpl <em>Structural Variation Prop</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see es.um.nosql.s13e.EntityDifferentiation.impl.StructuralVariationPropImpl
		 * @see es.um.nosql.s13e.EntityDifferentiation.impl.EntityDifferentiationPackageImpl#getStructuralVariationProp()
