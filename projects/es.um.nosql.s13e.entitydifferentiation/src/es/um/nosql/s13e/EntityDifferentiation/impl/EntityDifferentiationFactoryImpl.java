...
public class EntityDifferentiationFactoryImpl extends EFactoryImpl implements EntityDifferentiationFactory
{
  ...
  public EObject create(EClass eClass)
  {
		switch (eClass.getClassifierID()) {
			...
			case EntityDifferentiationPackage.STRUCTURAL_VARIATION_PROP: return createStructuralVariationProp();
			default:
  ...
  /**
	 ...
	 * @generated
	 */
	public StructuralVariationProp createStructuralVariationProp() {
		StructuralVariationPropImpl structuralVariationProp = new StructuralVariationPropImpl();
		return structuralVariationProp;
	}
