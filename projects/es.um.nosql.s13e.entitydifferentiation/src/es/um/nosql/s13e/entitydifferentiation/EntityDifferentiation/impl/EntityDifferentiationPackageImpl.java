...
public class EntityDifferentiationPackageImpl extends EPackageImpl implements EntityDifferentiationPackage
{
   ...
   * @generated
   */
  private EClass structuralVariationPropEClass = null;
   ...
   * @generated
   */
  public EReference getEntityDiffSpec_VariationProps()
  {
   ...
   * @generated
   */
  public EClass getStructuralVariationProp()
  {
    return structuralVariationPropEClass;
  }
   ...
   * @generated
   */
  public EReference getStructuralVariationProp_PropertySpecs()
  {
    return (EReference)structuralVariationPropEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getStructuralVariationProp_Variation()
  {
    return (EReference)structuralVariationPropEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getStructuralVariationProp_NotProps()
  {
    return (EReference)structuralVariationPropEClass.getEStructuralFeatures().get(2);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(entityDiffSpecEClass, ENTITY_DIFF_SPEC__VARIATION_PROPS);
    ...
    structuralVariationPropEClass = createEClass(STRUCTURAL_VARIATION_PROP);
    createEReference(structuralVariationPropEClass, STRUCTURAL_VARIATION_PROP__PROPERTY_SPECS);
    createEReference(structuralVariationPropEClass, STRUCTURAL_VARIATION_PROP__VARIATION);
    createEReference(structuralVariationPropEClass, STRUCTURAL_VARIATION_PROP__NOT_PROPS);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getEntityDiffSpec_Entity(), theNoSQLSchemaPackage.getEntityClass(), null, "entity", null, 1, 1, EntityDiffSpec.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getEntityDiffSpec_VariationProps(), this.getStructuralVariationProp(), null, "variationProps", null, 0, -1, EntityDiffSpec.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(structuralVariationPropEClass, StructuralVariationProp.class, "StructuralVariationProp", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getStructuralVariationProp_PropertySpecs(), this.getPropertySpec(), null, "propertySpecs", null, 0, -1, StructuralVariationProp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getStructuralVariationProp_Variation(), theNoSQLSchemaPackage.getStructuralVariation(), null, "variation", null, 1, 1, StructuralVariationProp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getStructuralVariationProp_NotProps(), this.getPropertySpec(), null, "notProps", null, 0, -1, StructuralVariationProp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
