...
import es.um.nosql.s13e.entitydifferentiation.m2m.NoSQLSchemaToEntityDiff;
import es.um.nosql.s13e.entitydifferentiation.util.EntityDifferentiationWriter;
import es.um.nosql.s13e.entitydifferentiation.m2t.mongoose.DiffMongooseBaseGen;
import es.um.nosql.s13e.entitydifferentiation.m2t.mongoose.DiffToMongoose;
import es.um.nosql.s13e.entitydifferentiation.m2t.morphia.DiffMorphiaBaseGen;
import es.um.nosql.s13e.entitydifferentiation.m2t.morphia.DiffToMorphia;
...
public class Main
{
  ...
  private static final String MORPHIA_OUTPUT_GEN_BASE_FOLDER = "src/es/um/nosql/s13e/entitydifferentiation/";
