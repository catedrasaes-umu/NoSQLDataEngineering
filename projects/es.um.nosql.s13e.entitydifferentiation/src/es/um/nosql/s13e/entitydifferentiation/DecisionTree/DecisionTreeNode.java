 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.nosql.s13e.entitydifferentiation.DecisionTree.DecisionTreeNode#getYesBranch <em>Yes Branch</em>}</li>
 *   <li>{@link es.um.nosql.s13e.entitydifferentiation.DecisionTree.DecisionTreeNode#getNoBranch <em>No Branch</em>}</li>
 * </ul>
 *
 * @see es.um.nosql.s13e.entitydifferentiation.DecisionTree.DecisionTreePackage#getDecisionTreeNode()
 * @model abstract="true"
 * @generated
 */
public interface DecisionTreeNode extends EObject
{
   ...
   * @see es.um.nosql.s13e.entitydifferentiation.DecisionTree.DecisionTreePackage#getDecisionTreeNode_YesBranch()
  ...
  /**
   * Sets the value of the '{@link es.um.nosql.s13e.entitydifferentiation.DecisionTree.DecisionTreeNode#getYesBranch <em>Yes Branch</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see es.um.nosql.s13e.entitydifferentiation.DecisionTree.DecisionTreePackage#getDecisionTreeNode_NoBranch()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link es.um.nosql.s13e.entitydifferentiation.DecisionTree.DecisionTreeNode#getNoBranch <em>No Branch</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
