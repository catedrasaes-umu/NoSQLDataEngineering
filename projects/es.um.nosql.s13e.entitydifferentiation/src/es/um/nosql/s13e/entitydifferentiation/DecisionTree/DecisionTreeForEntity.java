 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.nosql.s13e.entitydifferentiation.DecisionTree.DecisionTreeForEntity#getRoot <em>Root</em>}</li>
 *   <li>{@link es.um.nosql.s13e.entitydifferentiation.DecisionTree.DecisionTreeForEntity#getEntity <em>Entity</em>}</li>
 * </ul>
 *
 * @see es.um.nosql.s13e.entitydifferentiation.DecisionTree.DecisionTreePackage#getDecisionTreeForEntity()
 * @model
 * @generated
 */
public interface DecisionTreeForEntity extends EObject
{
   ...
   * @see es.um.nosql.s13e.entitydifferentiation.DecisionTree.DecisionTreePackage#getDecisionTreeForEntity_Root()
  ...
  /**
   * Sets the value of the '{@link es.um.nosql.s13e.entitydifferentiation.DecisionTree.DecisionTreeForEntity#getRoot <em>Root</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
