 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.nosql.s13e.entitydifferentiation.DecisionTree.LeafNode#getIdentifiedVariation <em>Identified Variation</em>}</li>
 * </ul>
 *
 * @see es.um.nosql.s13e.entitydifferentiation.DecisionTree.DecisionTreePackage#getLeafNode()
 * @model
 * @generated
 */
public interface LeafNode extends DecisionTreeNode
{
   ...
   * @see es.um.nosql.s13e.entitydifferentiation.DecisionTree.DecisionTreePackage#getLeafNode_IdentifiedVariation()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link es.um.nosql.s13e.entitydifferentiation.DecisionTree.LeafNode#getIdentifiedVariation <em>Identified Variation</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
