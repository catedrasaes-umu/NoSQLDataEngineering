...
import Variation_Diff.TupleType;
 ...
 * @generated
 */
public class Variation_DiffPackageImpl extends EPackageImpl implements Variation_DiffPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see Variation_Diff.Variation_DiffPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private Variation_DiffPackageImpl()
  {
    super(eNS_URI, Variation_DiffFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link Variation_DiffPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static Variation_DiffPackage init()
  {
    if (isInited) return (Variation_DiffPackage)EPackage.Registry.INSTANCE.getEPackage(Variation_DiffPackage.eNS_URI);

    // Obtain or create and register package
    Variation_DiffPackageImpl theVariation_DiffPackage = (Variation_DiffPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Variation_DiffPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Variation_DiffPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theVariation_DiffPackage.createPackageContents();

    // Initialize created meta-data
    theVariation_DiffPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theVariation_DiffPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(Variation_DiffPackage.eNS_URI, theVariation_DiffPackage);
    return theVariation_DiffPackage;
  }
   ...
   * @generated
   */
  public Variation_DiffFactory getVariation_DiffFactory()
  {
    return (Variation_DiffFactory)getEFactoryInstance();
  }
