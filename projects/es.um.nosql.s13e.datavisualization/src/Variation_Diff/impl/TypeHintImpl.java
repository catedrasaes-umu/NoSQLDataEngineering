 ...
 * </p>
 * <ul>
 *   <li>{@link Variation_Diff.impl.TypeHintImpl#getWithName <em>With Name</em>}</li>
 *   <li>{@link Variation_Diff.impl.TypeHintImpl#getWithType <em>With Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TypeHintImpl extends MinimalEObjectImpl.Container implements TypeHint
{
  ...
  {
    return Variation_DiffPackage.Literals.TYPE_HINT;
  }
  ...
  public void setWithName(String newWithName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Variation_DiffPackage.TYPE_HINT__WITH_NAME, oldWithName, withName));
  }
  ...
  public NotificationChain basicSetWithType(FieldType newWithType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Variation_DiffPackage.TYPE_HINT__WITH_TYPE, oldWithType, newWithType);
  ...
  public void setWithType(FieldType newWithType)
  {
    if (newWithType != withType)
    {
      ...
      if (withType != null)
        msgs = ((InternalEObject)withType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Variation_DiffPackage.TYPE_HINT__WITH_TYPE, null, msgs);
      if (newWithType != null)
        msgs = ((InternalEObject)newWithType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Variation_DiffPackage.TYPE_HINT__WITH_TYPE, null, msgs);
      msgs = basicSetWithType(newWithType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Variation_DiffPackage.TYPE_HINT__WITH_TYPE, newWithType, newWithType));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Variation_DiffPackage.TYPE_HINT__WITH_TYPE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Variation_DiffPackage.TYPE_HINT__WITH_NAME:
        return getWithName();
      case Variation_DiffPackage.TYPE_HINT__WITH_TYPE:
        return getWithType();
    }
