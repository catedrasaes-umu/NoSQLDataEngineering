...
class CompareSimpleFeature extends Comparator<SimpleFeature>
{
  override boolean compare(SimpleFeature f1, SimpleFeature f2)
  {
    ...
    if (f1.type !== null && f2.type !== null)
    {
      ...
      if (f1.type instanceof SimpleAggregationTarget && f2.type instanceof SimpleAggregationTarget)
        return new CompareSimpleAggregationTarget().compare(f1.type as SimpleAggregationTarget, f2.type as SimpleAggregationTarget)
