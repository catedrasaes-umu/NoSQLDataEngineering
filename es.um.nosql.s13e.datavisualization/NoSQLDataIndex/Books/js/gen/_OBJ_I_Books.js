var DiffMethodsInclusive =
{
	...
	isOfExactType_Publisher_3: function (obj)
	{
		if (!("name" in obj) || !(typeof obj.name === "string"))
			return false;
		if (!("journal" in obj) || (typeof obj.journal === "string" && false)
	...
	isOfExactType_Book_1: function (obj)
	{
		...
		if (!("year" in obj) || !(typeof obj.year === "number") || !(obj.year % 1 === 0))
			return false;
		if (!("publisher" in obj) || (typeof obj.publisher === "string" && false)
			...
			return false;
		if (!("content" in obj) || (typeof obj.content === "object" && !(obj.content instanceof Array) && (!this.isOfExactType_Content_1(obj.content)))
			...
			return false;
		if (!("author" in obj) || (typeof obj.author === "object" && !(obj.author instanceof Array) && (!this.isOfExactType_Author_1(obj.author)))
	...
	isOfExactType_Author_1: function (obj)
	{
		if (!("name" in obj) || !(typeof obj.name === "string"))
			return false;
		if (!("company" in obj) || (typeof obj.company === "object" && !(obj.company instanceof Array) && (!this.isOfExactType_Company_1(obj.company)))
