 ...
 * @generated
 */
public class Version_DiffSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Version_DiffPackage.HAS_NOT_FIELD: {
			...
			case Version_DiffPackage.FIELD_TYPE: {
				FieldType fieldType = (FieldType)theEObject;
				T result = caseFieldType(fieldType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Version_DiffPackage.PRIMITIVE_TYPE: {
			...
			case Version_DiffPackage.TUPLE_TYPE: {
			...
			case Version_DiffPackage.ASSOCIATION_TYPE: {
			...
			case Version_DiffPackage.AGGREGATE_TYPE: {
			...
			case Version_DiffPackage.REFERENCE_TYPE: {
			...
			case Version_DiffPackage.ENTITY_TYPE: {
			...
			case Version_DiffPackage.HOMOGENEOUS_TUPLE_TYPE: {
			...
			case Version_DiffPackage.HETEROGENEOUS_TUPLE_TYPE: {
