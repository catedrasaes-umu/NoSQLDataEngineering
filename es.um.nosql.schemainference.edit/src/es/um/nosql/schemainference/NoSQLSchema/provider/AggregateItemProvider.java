...
/**
 * This is the item provider adapter for a {@link es.um.nosql.schemainference.NoSQLSchema.Aggregate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Aggregate_refTo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Aggregate_refTo_feature", "_UI_Aggregate_type"),
				 NoSQLSchemaPackage.Literals.AGGREGATE__REF_TO,
				 true,
				 false,
				 true,
				 null,
