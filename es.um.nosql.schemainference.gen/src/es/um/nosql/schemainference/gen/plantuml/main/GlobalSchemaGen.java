...
import es.um.nosql.schemainference.gen.plantuml.xtend.GlobalSchemaGenerator;
import es.um.nosql.schemainference.util.emf.ResourceManager;

public class GlobalSchemaGen {
	...
	{
		(new GlobalSchemaGen()).execute(args);
	}
	...
	protected void execute(String[] args) throws FileNotFoundException
	{
		...
		GlobalSchemaGenerator gen = new GlobalSchemaGenerator();
