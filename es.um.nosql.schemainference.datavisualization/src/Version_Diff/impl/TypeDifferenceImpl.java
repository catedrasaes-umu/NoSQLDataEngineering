 ...
 * </p>
 * <ul>
 *   <li>{@link Version_Diff.impl.TypeDifferenceImpl#getName <em>Name</em>}</li>
 *   <li>{@link Version_Diff.impl.TypeDifferenceImpl#getHints <em>Hints</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeDifferenceImpl extends MinimalEObjectImpl.Container implements TypeDifference {
	...
	protected EClass eStaticClass() {
		return Version_DiffPackage.Literals.TYPE_DIFFERENCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Version_DiffPackage.TYPE_DIFFERENCE__NAME, oldName, name));
	}
	...
	public EList<TypeHint> getHints() {
		if (hints == null) {
			hints = new EObjectContainmentEList<TypeHint>(TypeHint.class, this, Version_DiffPackage.TYPE_DIFFERENCE__HINTS);
		}
		return hints;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Version_DiffPackage.TYPE_DIFFERENCE__HINTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Version_DiffPackage.TYPE_DIFFERENCE__NAME:
				return getName();
			case Version_DiffPackage.TYPE_DIFFERENCE__HINTS:
				return getHints();
		}
