/**
 */
package es.um.nosql.schemainference.entitydifferentiation.util;

import es.um.nosql.schemainference.entitydifferentiation.*;
...
public class EntitydifferentiationAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.um.nosql.schemainference.entitydifferentiation.EntityDifferentiation <em>Entity Differentiation</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.um.nosql.schemainference.entitydifferentiation.EntityDiffSpec <em>Entity Diff Spec</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.um.nosql.schemainference.entitydifferentiation.PropertySpec <em>Property Spec</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.um.nosql.schemainference.entitydifferentiation.EntityVersionProp <em>Entity Version Prop</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
