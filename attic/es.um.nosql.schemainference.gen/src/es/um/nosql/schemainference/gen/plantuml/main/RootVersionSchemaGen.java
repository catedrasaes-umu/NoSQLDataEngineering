...
import es.um.nosql.schemainference.gen.plantuml.xtend.RootVersionSchemaGenerator;
import es.um.nosql.schemainference.util.emf.ResourceManager;


public class RootVersionSchemaGen {
	...
	protected void execute(String[] args) throws FileNotFoundException
	{
		...
		RootVersionSchemaGenerator gen = new RootVersionSchemaGenerator();
