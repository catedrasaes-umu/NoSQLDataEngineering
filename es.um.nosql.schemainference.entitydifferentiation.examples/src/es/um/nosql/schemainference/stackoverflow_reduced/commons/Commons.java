package es.um.nosql.schemainference.stackoverflow_reduced.commons;
...
public class Commons
{
  ...
  private static Morphia GET_MORPHIA()
  {
    if (MORPHIA_INSTANCE == null)
    {
      ...
      MORPHIA_INSTANCE = MORPHIA_INSTANCE.mapPackage("es.um.nosql.schemainference.stackoverflow_reduced");
    }
